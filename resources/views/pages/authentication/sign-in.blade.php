...
<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        <p class="text-center">
            <a href="{{ route('dashboard.home') }}" class="d-flex align-items-center justify-content-center">
                ...
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    ...
                    <form action="#" class="mt-4" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex justify-content-between align-items-top mb-4">
                                ...
                                <div><a href="{{ route('auth.forgot-password') }}" class="small text-right">Lost password?</a></div>
                            </div>
                        </div>
                        <div class="d-grid">
                            <a href="{{ route('dashboard.home') }}" type="submit" class="btn btn-gray-800">Sign in</a>
                        </div>
                    </form>
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-4">
                        <span class="fw-normal">
                            Not registered?
                            <a href="{{ route('auth.sign-up') }}" class="fw-bold">Create account</a>
                        </span>
                    </div>
                </div>
            </div>
