<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item @if(request()->is('dashboard/transactions')) active @endif">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse @if(request()->is('dashboard/tables')) show @endif" role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item @if(request()->is('dashboard/tables')) active @endif">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse " role="list" id="submenu-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('auth.sign-in') }}">
                                <span class="sidebar-text">Sign In</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('auth.sign-up') }}">
                                <span class="sidebar-text">Sign Up</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('auth.forgot-password') }}">
                                <span class="sidebar-text">Forgot password</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('auth.reset-password') }}">
                                <span class="sidebar-text">Reset password</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('auth.locked') }}">
                                <span class="sidebar-text">Lock</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('error.404') }}">
                                <span class="sidebar-text">404 Not Found</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('error.500') }}">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse @if(request()->is('dashboard/components/*')) show @endif" role="list" id="submenu-components" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                        ...
                        <li class="nav-item @if(request()->is('dashboard/components/buttons')) active @endif">
                            <a class="nav-link" href="{{ route('dashboard.buttons') }}">
                                <span class="sidebar-text">Buttons</span>
                            </a>
                        </li>
                        <li class="nav-item @if(request()->is('dashboard/components/notifications')) active @endif">
                            <a class="nav-link" href="{{ route('dashboard.notifications') }}">
                                <span class="sidebar-text">Notifications</span>
                            </a>
                        </li>
                        <li class="nav-item @if(request()->is('dashboard/components/forms')) active @endif">
                            <a class="nav-link" href="{{ route('dashboard.forms') }}">
                                <span class="sidebar-text">Forms</span>
                            </a>
                        </li>
                        <li class="nav-item @if(request()->is('dashboard/components/modals')) active @endif">
                            <a class="nav-link" href="{{ route('dashboard.modals') }}">
                                <span class="sidebar-text">Modals</span>
                            </a>
                        </li>
                        <li class="nav-item @if(request()->is('dashboard/components/typography')) active @endif">
            ...
            <li class="nav-item">
                <a href="https://themesberg.com" target="_blank" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset('images/themesberg.svg') }}" height="20" width="28" alt="Themesberg Logo">
                    </span>
                    <span class="sidebar-text">Themesberg</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('pro') }}" class="btn btn-secondary d-flex align-items-center justify-content-center btn-upgrade-pro">
