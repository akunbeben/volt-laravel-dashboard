            ...
            <table class="table table-centered table-nowrap mb-0 rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="{{ asset('images/flags/united-states-of-america.svg') }}">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="{{ asset('images/flags/canada.svg') }}">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="{{ asset('images/flags/united-kingdom.svg') }}">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="{{ asset('images/flags/france.svg') }}">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="{{ asset('images/flags/japan.svg') }}">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="{{ asset('images/flags/germany.svg') }}">
